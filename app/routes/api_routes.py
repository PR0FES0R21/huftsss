...
class ApiBlueprint:
    ...
    def add_data(self, entities):
        ...
        if entities == 'guru':
            return self.teacher_controller.add_teacher(data)

        elif entities == 'siswa':
            return self.student_controller.add_student(data)
            ...
            print(data)
            return self.quest_controller.add_question(data)
        
        elif entities == 'mapel':
            return self.subject_controller.add_subject(data)
        
        elif entities == 'kelas':
            return self.class_controller.add_class(data)
    ...
    def get_data(self, type:str, entities:str):        
        ...
        if entities == 'guru':
            ...
            if request.args.get('id'):
                return self.teacher_controller.get_teacher_data_by_id(request.args.get('id'))
            return self.teacher_controller.get_teacher_data(None)
            ...
            if request.args.get('id'):
                return self.student_controller.get_student_data_by_id(request.args.get('id'))
            return self.student_controller.get_student_data(request.args.get('id'), program_keahlian, jenjang_kelas)
            
        elif entities == 'ujian':
            if current_user.role != 'admin':
                if type == 'daftar':
                    return self.exam_controller.get_exam_data_by_category(current_user.id, current_user.departemen, current_user.position)
                if type == 'daftar_selesai':
                    return self.exam_controller.get_exam_data_by_category_done(current_user.id)
            ...
            if request.args.get('id'):
                return self.exam_controller.get_exam_data_by_id(request.args.get('id'))
            return self.exam_controller.get_exam_data(request.args.get('id'))
            ...
            if request.args.get('exam_id'):
                return self.quest_controller.get_question_data_by_exam_id(request.args.get('exam_id'))
            elif request.args.get('id'):
                return self.quest_controller.get_question_data_by_id(request.args.get('id'))
            return self.quest_controller.get_question_data(request.args.get('id'))
            ...
            if request.args.get('id'):
                return self.subject_controller.get_subject_by_id(request.args.get('id'))
            return self.subject_controller.get_subject_data(None)
            ...
            if request.args.get('id'):
                return self.class_controller.get_class_by_id(request.args.get('id'))
            return self.class_controller.get_class_data(None)
    ...
    def delete_data(self, entities):
        ...
        if entities == 'guru' and current_user.role == 'admin':
            return self.teacher_controller.delete_teacher(id)
        
        elif entities == 'siswa':
            return self.student_controller.delete_student(id)
        
        elif entities == 'ujian':
            return self.exam_controller.delete_exam(id)
        
        elif entities == 'soal':
            return self.quest_controller.delete_question(id)
        
        elif entities == 'mapel':
            return self.subject_controller.delete_subject(id)
        
        elif entities == 'kelas':
            return self.class_controller.delete_class(id)
        return jsonify({'status': 404, 'message': 'Not Found'})
    ...
    def update_data(self, entities):
        ...
        if entities == 'guru':
            return self.teacher_controller.update_teacher(data)
        
        elif entities == 'siswa':
            return self.student_controller.update_student(data)
            ...
            return self.quest_controller.update_question(data)
        
        elif entities == 'mapel':
            return self.subject_controller.update_subject(data)
        
        elif entities == 'kelas':
            return self.class_controller.update_class(data)
        return jsonify({'status': 404, 'message': 'Not Found'})
    ...
    def delete_all_data(self, entities):
        ...
        if entities == 'guru':
            return self.teacher_controller.delete_all_teacher()
        elif entities == 'siswa':
            return self.student_controller.delete_all_student()
        elif entities == 'ujian':
            return self.exam_controller.delete_all_exam()
        elif entities == 'soal':
            id_exam = request.form['id']
            return self.quest_controller.delete_all_question(id_exam)
        elif entities == 'mapel':
            return self.subject_controller.delete_all_subject()
        elif entities == 'kelas':
            return self.class_controller.delete_all_class()
        return jsonify({'status': 404, 'message': 'Not Found'})
    ...
    def tracking(self, entities):
        ...
        if entities == 'user_online':
            return self.admin_controller.get_user_logger()
    ...
    def test(self):
        return self.admin_controller.test(current_user.id)
