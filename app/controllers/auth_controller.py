...
class AuthController:
    ...
    def login_validation(self, username, password, platform):
        ...
        user = User(valid_entity['_id'], valid_entity['peran'], valid_entity['nama'], position, platform)
        login_user(user)
        ...
        self.auth_service.tracking(data)
